...
import aboutUsBgImg from '../common/image/about-page-firstPic.png'
import AboutPageSecondPic from '../common/image/about-page-secondPic.png'
const AboutUsPage = () => {
    return (
        <div class="wrapper">
      {/* <header class="header">
        ...
        <section class="about-info">
          <div class="container">
            ...
            <div class="about-info_bottom d-flex">
              <img src={AboutPageSecondPic} alt="" />
              <div>
