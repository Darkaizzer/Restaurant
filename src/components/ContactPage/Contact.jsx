import "./Contact.css";
import facebook from '../common/image/facebook 1.svg'
import google from '../common/image/google 1.svg'
import Group from '../common/image/Group 63.svg'
      ...
      <main className="main">
        ...
        <section className="contact-info">
          <div className="container">
            <h3>Информация</h3>
            <p>
              Humblebrag la croix, pok pok aesthetic fam flexitarian wayfarers
              health goth sustainable try-hard brooklyn authentic live-edge.
            ...
            <div className="contact-info__address d-flex">
              ...
              <div className="d-flex">
                ...
                <div>
                  <p>Email</p>
                  <p>
                    <a href="mailto:arykov.azat.kg@gmail.com">
                      email@gmail.com
                    </a>{" "}
                  </p>
                </div>
